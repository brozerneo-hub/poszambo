 ...
 */
export const calculateVAT = (priceHT: number, vatRate: number): number => {
 ...
 */
export const calculateTTC = (priceHT: number, vatAmount: number): number => {
 ...
 */
export const reverseVAT = (priceTTC: number, vatRate: number): { priceHT: number; vatAmount: number } => {
